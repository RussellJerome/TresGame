...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UCriWareInitializer()
	{
		...
		if (!OuterClass)
		{
			...
			OuterClass = UCriWareInitializer::StaticClass();
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UCriWareInitializer> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				MetaData->SetValue(OuterClass, TEXT("IncludePath"), TEXT("CriWareInitializer.h"));
				MetaData->SetValue(OuterClass, TEXT("ModuleRelativePath"), TEXT("Public/CriWareInitializer.h"));
#endif
			}
		}
	...
	IMPLEMENT_CLASS(UCriWareInitializer, 742202319);
