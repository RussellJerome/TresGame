...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UHoudiniAssetParameterFolderList()
	{
		...
		if (!OuterClass)
		{
			...
			OuterClass = UHoudiniAssetParameterFolderList::StaticClass();
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UHoudiniAssetParameterFolderList> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				MetaData->SetValue(OuterClass, TEXT("IncludePath"), TEXT("HoudiniAssetParameterFolderList.h"));
				MetaData->SetValue(OuterClass, TEXT("ModuleRelativePath"), TEXT("Public/HoudiniAssetParameterFolderList.h"));
#endif
			}
		}
	...
	IMPLEMENT_CLASS(UHoudiniAssetParameterFolderList, 799381817);
