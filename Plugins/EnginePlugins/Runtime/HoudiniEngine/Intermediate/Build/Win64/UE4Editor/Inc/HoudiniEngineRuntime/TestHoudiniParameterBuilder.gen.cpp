...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UTestHoudiniParameterBuilder()
	{
		...
		if (!OuterClass)
		{
			...
			OuterClass = UTestHoudiniParameterBuilder::StaticClass();
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UTestHoudiniParameterBuilder> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				MetaData->SetValue(OuterClass, TEXT("IncludePath"), TEXT("TestHoudiniParameterBuilder.h"));
				MetaData->SetValue(OuterClass, TEXT("ModuleRelativePath"), TEXT("Public/TestHoudiniParameterBuilder.h"));
#endif
			}
		}
	...
	IMPLEMENT_CLASS(UTestHoudiniParameterBuilder, 4250266255);
