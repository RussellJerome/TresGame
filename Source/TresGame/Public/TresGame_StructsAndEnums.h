...
enum ETresItemDefAccessory
{
	...
	ETresItemDefAccessory_ITEM01 = 1 UMETA(DisplayName = "Item 1"),
	ETresItemDefAccessory_ITEM02 = 2 UMETA(DisplayName = "Item 2"),
	ETresItemDefAccessory_ITEM03 = 3 UMETA(DisplayName = "Item 3"),
	ETresItemDefAccessory_ITEM04 = 4 UMETA(DisplayName = "Item 4"),
	ETresItemDefAccessory_ITEM05 = 5 UMETA(DisplayName = "Item 5"),
	ETresItemDefAccessory_ITEM06 = 6 UMETA(DisplayName = "Item 6"),
	ETresItemDefAccessory_ITEM07 = 7 UMETA(DisplayName = "Item 7"),
	ETresItemDefAccessory_ITEM08 = 8 UMETA(DisplayName = "Item 8"),
	ETresItemDefAccessory_ITEM09 = 9 UMETA(DisplayName = "Item 9"),
