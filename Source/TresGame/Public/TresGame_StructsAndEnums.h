...
enum ETresProjectileInnerWaterVolumeProc
{
	...
	ETresProjectileInnerWaterVolumeProc_MAX = 5 UMETA(DisplayName = "MAX")
};
...
enum ETresHologramSubAnimReplaceType
{
	...
	ETresHologramSubAnimReplaceType_1_Max = 7,
...
enum ETresGumiShipWeaponPrimType
{
	...
	ETresGumiShipWeaponPrimType_TYPE_MAX = 6,
...
enum ETresGumiShipBadStateType
{
	...
	ETresGumiShipBadStateType_BS_MAX = 2
};
...
enum ETresEnemyEx009ActionKind
{
	...
	Right_Step = 1,
	Left_Step = 2,
	ETresEnemyEx009ActionKind_1_MAX = 3,
...
enum ETresEnemyEx016ActionKind
{
	...
	ETresEnemyEx016ActionKind_1_MAX = 1,
...
enum ETresEnemyEx304WarpType
{
	...
	ETresEnemyEx304WarpType_1_MAX = 2,
...
enum ETresEnemyEx361CounterAfterActionKind
{
	...
	ETresEnemyEx361CounterAfterActionKind_1_MAX = 2,
...
enum ETresEnemyEEX771_ACTION_1WARP_KIND
{
	...
	ETresEnemyEEX771_ACTION_1WARP_KIND_WARP_KIND_MAX = 4
};
...
enum ETresEnemyEEX773_ACTION_1WARP_KIND
{
	...
	ETresEnemyEEX773_ACTION_1WARP_KIND_WARP_KIND_MAX = 4
};
...
enum ETresEnemyEEX771_POINT_KIND
{
	...
	ETresEnemyEEX771_POINT_KIND_POINT_KIND_MAX = 6
};
...
enum ETresEnemyEEX773_POINT_KIND
{
	...
	ETresEnemyEEX773_POINT_KIND_POINT_KIND_MAX = 8
};
...
enum ETresEnemyEx006ScrumState
{
	...
	ETresEnemyEx006ScrumState_1_MAX = 6,
...
enum ETresEnemyEx361ComboKind
{
	...
	ETresEnemyEx361ComboKind_1_MAX = 5,
...
enum ETresEnemyEx302ComboKind
{
	...
	Combo_AirShotDown = 6,
	ETresEnemyEx302ComboKind_1_MAX = 7,
...
enum ETresEnemyEx304ComboKind
{
	...
	Combo_FinishBlow = 3,
	Combo_FinishToss = 4,
	ETresEnemyEx304ComboKind_1_MAX = 5,
...
enum ETresItemRank
{
	...
	ETresItemRank_1_MAX = 5 UMETA(DisplayName = "MAX"),
	ETresItemRank_MAX = 6 UMETA(DisplayName = "Tres Item Rank MAX")
};
...
enum ETresItemSubCategoryKeyItem
{
	...
	ETresItemSubCategoryKeyItem_1_MAX = 3,
...
enum ETresItemSubCategoryFoodStuff
{
	...
	SEVENPUDDING = 5,
	MEAT = 6,
	ETresItemSubCategoryFoodStuff_1_MAX = 7,
...
enum ETresItemSubCategoryFood
{
	...
	ETresItemSubCategoryFood_1_MAX = 5,
...
enum ETresItemCategoryIcon
{
	...
	ETresItemCategoryIcon_1_MAX = 23,
...
enum ERemyRecipeType
{
	...
	ERemyRecipeType_1_MAX = 29 UMETA(DisplayName = "MAX"),
	RemyRecipeType_MAX = 30 UMETA(DisplayName = "Remy Recipe Type MAX")
};
...
enum ETresShopChrID
{
	ETresShopChrID_MOOGLE = 0,
	ETresShopChrID_HUEY = 1,
	ETresShopChrID_DEWEY = 2,
	ETresShopChrID_LOUIE = 3,
	ETresShopChrID_1_MAX = 4,
...
enum ETresSoundAliasLabel_Projectile
{
	...
	ETresSoundAliasLabel_Projectile_1_MAX = 3 UMETA(DisplayName = "MAX"),
	ETresSoundAliasLabel_Projectile_MAX = 4 UMETA(DisplayName = "Tres Sound Alias Label Projectile MAX")
};
...
enum ETresSoundAliasLabel_WeaponSwing
{
	...
	ETresSoundAliasLabel_WeaponSwing_1_MAX = 14 UMETA(DisplayName = "MAX"),
	ETresSoundAliasLabel_WeaponSwing_MAX = 15 UMETA(DisplayName = "Tres Sound Alias Label Weapon Swing MAX")
};
...
enum ETresSoundAliasLabel_WeaponHit
{
	...
	ETresSoundAliasLabel_WeaponHit_1_MAX = 12 UMETA(DisplayName = "MAX"),
	ETresSoundAliasLabel_WeaponHit_MAX = 13 UMETA(DisplayName = "Tres Sound Alias Label Weapon Hit MAX")
};
...
enum ETresSoundAliasUnit
{
	...
	ETresSoundAliasUnit_1_MAX = 5 UMETA(DisplayName = "MAX"),
	ETresSoundAliasUnit_MAX = 6 UMETA(DisplayName = "Tres Sound Alias Unit MAX")
};
...
enum ETresCategoryVolumeLayers
{
	...
	ETresCategoryVolumeLayers_MAX = 2
};
...
enum ETresEffectCustomAreaCode
{
	...
	TRES_EFFECT_CUSTOM_AREA_MAX = 31
};
...
enum ETresDlcChallengeRank
{
	...
	RANK11 = 12,
	RANK12 = 13,
	ETresDlcChallengeRank_1_Max = 14,
...
enum ETresDlcChallengeCode
{
	...
	BanMogMedal = 12,
	_CodeMax = 13,
	ETresDlcChallengeCode_1_Max = 14,
...
enum ETresDlcCheatCode
{
	...
	ETresDlcCheatCode_1_Max = 16,
	ETresDlcCheatCode_MAX = 17
};
...
enum ETresWeaponForm
{
	...
	ETresWeaponForm_1_TRES_WEAPON_FORM_MAX = 25
};
...
enum ETresDamageLeaveOneType
{
	...
	ETresDamageLeaveOneType_1_MAX = 5,
...
enum ETresUISlideShowDataType
{
	...
	ETresUISlideShowDataType_1_Max = 2,
...
{
	ETresUIDataVersion_None = 0,
	ETresUIDataVersion_DLC = 1,
	ETresUIDataVersion_1_Max = 2,
...
{
	ETresUIDialogColor_World = 0,
	ETresUIDialogColor_DH = 1,
...
{
	ETresUIDictionaryEnemyCategory_Heartless = 0,
	ETresUIDictionaryEnemyCategory_Nobody = 1,
	ETresUIDictionaryEnemyCategory_Unversed = 2,
	ETresUIDictionaryEnemyCategory_Other = 3,
	ETresUIDictionaryEnemyCategory_1_Max = 4,
...
{
	ETresUIValueCompareType_GreaterEq = 0,
	ETresUIValueCompareType_Grater = 1,
	ETresUIValueCompareType_LessEq = 2,
	ETresUIValueCompareType_Less = 3,
	ETresUIValueCompareType_Equal = 4,
	ETresUIValueCompareType_NotEqual = 5,
	ETresUIValueCompareType_None = 6,
...
enum ETresUICharaID
{
	ETresUICharaID_SORA = 0,
	ETresUICharaID_RIKU = 1,
	ETresUICharaID_KAIRI = 2,
	ETresUICharaID_MICKEY = 3,
	ETresUICharaID_DONALD = 4,
	ETresUICharaID_GOOFY = 5,
	ETresUICharaID_TERRA = 6,
	ETresUICharaID_VENTUS = 7,
	ETresUICharaID_AQUA = 8,
	ETresUICharaID_ROXAS = 9,
	ETresUICharaID_LEA = 10,
	ETresUICharaID_XION = 11,
	ETresUICharaID_JACK_SPARROW = 12,
	ETresUICharaID_WOODY = 13,
	ETresUICharaID_BUZZ = 14,
	ETresUICharaID_HERCULES = 15,
	ETresUICharaID_RAPUNZEL = 16,
	ETresUICharaID_FLYNN = 17,
	ETresUICharaID_SULLEY = 18,
	ETresUICharaID_MIKE = 19,
	ETresUICharaID_BOO = 20,
	ETresUICharaID_MARSHMALLOW = 21,
	ETresUICharaID_BAYMAX = 22,
	ETresUICharaID_IENZO = 23,
	ETresUICharaID_PENCE = 24,
	ETresUICharaID_UNKNOWN = 25,
...
{
	ETresUILSIScoreType_Score = 0,
	ETresUILSIScoreType_Stage = 1,
	ETresUILSIScoreType_Win = 2,
	ETresUILSIScoreType_BarnyardSports = 3,
	ETresUILSIScoreType_TheMusicalFarmer = 4,
	ETresUILSIScoreType_HowToPlayGolf = 5,
	ETresUILSIScoreType_HowToPlayBaseball = 6,
...
{
	ETresUIShopType_Normal = 0,
	ETresUIShopType_Gummi_Huey = 1,
	ETresUIShopType_Gummi_Dewey = 2,
	ETresUIShopType_Gummi_Louie = 3,
	ETresUIShopType_1_Max = 4,
...
enum ETresUINauticalChartPoint
{
	...
	No12 = 11,
	No13 = 12,
	ETresUINauticalChartPoint_1_MAX = 13,
...
{
	ETresUIHudSpecialShip_Normal = 0,
	ETresUIHudSpecialShip_Marker = 1,
	ETresUIHudSpecialShip_1_MAX = 2,
...
{
	ETresUIHudScoreMode_None = 0,
	ETresUIHudScoreMode_Default = 1,
	ETresUIHudScoreMode_Pudding = 2,
	ETresUIHudScoreMode_1_MAX = 3,
...
{
	ETresUIGigasGameResultRank_A = 0,
	ETresUIGigasGameResultRank_B = 1,
	ETresUIGigasGameResultRank_C = 2,
	ETresUIGigasGameResultRank_D = 3,
	ETresUIGigasGameResultRank_Max = 4,
...
{
	ETresUIGigasGameStartSignalType_Ready = 0,
	ETresUIGigasGameStartSignalType_Start = 1,
...
{
	ETresUIFullscreenVideoCallbackType_PlayTimeOut = 0,
	ETresUIFullscreenVideoCallbackType_PlayFinish = 1,
	ETresUIFullscreenVideoCallbackType_Prepared = 2,
...
{
	ETresUIMapMarkerType_SavePoint = 0,
	ETresUIMapMarkerType_Shop = 1,
	ETresUIMapMarkerType_MapLine = 2,
	ETresUIMapMarkerType_EnemyGigas = 3,
	ETresUIMapMarkerType_EnemyGigasAce = 4,
	ETresUIMapMarkerType_Gigas = 5,
	ETresUIMapMarkerType_EnemySea = 6,
	ETresUIMapMarkerType_EnemySeaLuxord = 7,
	ETresUIMapMarkerType_1_Max = 8,
...
{
	ETresVBonusAbilityType_NONE = 0,
	ETresVBonusAbilityType_EQUIP = 1,
	ETresVBonusAbilityType_HAVE = 2,
	ETresVBonusAbilityType_1_MAX = 3,
