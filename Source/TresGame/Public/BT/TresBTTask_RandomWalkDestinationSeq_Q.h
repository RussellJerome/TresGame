 ...
 */
UCLASS()
class TRESGAME_API UTresBTTask_RandomWalkDestinationSeq_Q : public UTresBTTask_SequentialExecProcess
{
	GENERATED_BODY()
public:
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "TresBTTask_RandomWalkDestinationSeq_Q")
