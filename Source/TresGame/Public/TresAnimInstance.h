...
public:
    ...
    UFUNCTION(BlueprintCallable)
    float SQEX_FaceAnimPlayType(ETresFaceAnimType InAnimType, float InBlendInTime, bool InLoop, float InPlayRate, const FVector& InBlendParam, bool InSameCheck, TEnumAsByte<ETresFaceAnimPlayPriority> InPlayPriority);
    ...
    UFUNCTION(BlueprintCallable)
    float SQEX_FaceAnimLipPlayType(ETresFaceAnimType InAnimType, float InBlendInTime, bool InLoop, float InPlayRate, const FVector& InBlendParam, bool InSameCheck, TEnumAsByte<ETresFaceAnimPlayPriority> InPlayPriority);
    ...
    UFUNCTION(BlueprintCallable)
    float SQEX_FaceAnimEyePlayType(ETresFaceAnimType InAnimType, float InBlendInTime, bool InLoop, float InPlayRate, const FVector& InBlendParam, bool InSameCheck, TEnumAsByte<ETresFaceAnimPlayPriority> InPlayPriority);
    ...
    UFUNCTION(BlueprintCallable)
    void NotifyDamageCaution(ETresRiskDodgeType InDodgeType, float InTime, float inAngle);
