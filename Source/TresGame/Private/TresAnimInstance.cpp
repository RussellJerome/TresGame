...
float UTresAnimInstance::SQEX_FaceAnimPlayType(ETresFaceAnimType InAnimType, float InBlendInTime, bool InLoop, float InPlayRate, const FVector& InBlendParam, bool InSameCheck, TEnumAsByte<ETresFaceAnimPlayPriority> InPlayPriority) {
    return 0.0f;
}
...
float UTresAnimInstance::SQEX_FaceAnimLipPlayType(ETresFaceAnimType InAnimType, float InBlendInTime, bool InLoop, float InPlayRate, const FVector& InBlendParam, bool InSameCheck, TEnumAsByte<ETresFaceAnimPlayPriority> InPlayPriority) {
    return 0.0f;
}
...
float UTresAnimInstance::SQEX_FaceAnimEyePlayType(ETresFaceAnimType InAnimType, float InBlendInTime, bool InLoop, float InPlayRate, const FVector& InBlendParam, bool InSameCheck, TEnumAsByte<ETresFaceAnimPlayPriority> InPlayPriority) {
    return 0.0f;
}
...
void UTresAnimInstance::NotifyDamageCaution(ETresRiskDodgeType InDodgeType, float InTime, float inAngle) {
}
...
UTresAnimInstance::UTresAnimInstance() {
    ...
    this->m_AutoPlayFaceAnimType = ETresFaceAnimType::NORMAL_AUTO;
